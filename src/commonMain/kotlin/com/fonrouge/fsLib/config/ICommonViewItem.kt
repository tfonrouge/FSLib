...
abstract class ICommonViewItem<T : BaseDoc<ID>, ID : Any, FILT : IApiFilter>(
    ...
    var onQueryFail: (ICommonViewItem<T, ID, FILT>.(ApiItem<T, ID, FILT>?) -> Unit)? = null
    var onQuerySuccess: (ICommonViewItem<T, ID, FILT>.(ApiItem<T, ID, FILT>?) -> Unit)? = null
    var onActionFail: (ICommonViewItem<T, ID, FILT>.(ApiItem<T, ID, FILT>?) -> Unit)? = null
    var onActionSuccess: (ICommonViewItem<T, ID, FILT>.(ApiItem<T, ID, FILT>?) -> Unit)? = null
}
