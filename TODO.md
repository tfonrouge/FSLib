...
Origen y evidencia: mppArel `blueprints/EjecucionTallerMoldes(MODULE)/LEDGER.md` L-104 (recorrido), L-106 (board), G-022 (modal). Medido sobre fsLib 6.2.4 y KVision 9.5.0.
